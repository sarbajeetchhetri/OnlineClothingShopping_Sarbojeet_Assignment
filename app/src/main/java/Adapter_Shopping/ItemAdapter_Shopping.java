...
import com.onlineclothingshopping.DetailActivity_shopping;
...
public class ItemAdapter_Shopping extends RecyclerView.Adapter<ItemAdapter_Shopping.ItemViewHolder> {
    ...
    public ItemAdapter_Shopping(Context mContext, List<ItemModel> itemModelList) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder itemViewHolder, final int i) {
        ...
        itemViewHolder.imgview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext, DetailActivity_shopping.class);
